...
public class Constants {
  ...
  public class DrivetrainConstants {
    ...
    private static final double kBackLeftEncoderOffset = 0.44873046875;
    ...
    private static final double kBackRightEncoderOffset = 0.362548828125;
  ...
  public static class TransferHookConstants {
    ...
    public static final double TRANSFER_HOOK_POS_CLIMB = 87.28515625;

    // motion magic constraints
    public static final double TRANSFER_HOOK_CRUISE_VELOCITY = 2000;
    public static final double TRANSFER_HOOK_ACCELERATION = 700;
    public static final double TRANSFER_HOOK_JERK = 10000;
  ...
  public static class PivotConstants {
    ...
    public static final double PIVOT_STOW_POS = 14.5;
    ...
    public static final double PIVOT_TRAP_POS = -78;

    // TODO: Change these values
    public static final double PIVOT_CLIMB_UP_POS = -12.61279296875;
    public static final double PIVOT_CLIMB_DOWN_POS = 22.4453125;
  ...
  public static class LimelightConstants {
    ...
    public static final double MULTI_TAG_XY_STD_DEV = 0.8; // TODO: tune based on empirical discrepancy
    public static final double SINGLE_TAG_XY_STD_DEV = 1.5; // TODO: tune based on empirical discrepancy
  }
