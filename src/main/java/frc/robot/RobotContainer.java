...
public class RobotContainer {
    ...
    private void setupAutoChooser() {
        ...
        // autoChooser.addOption("4 Piece Load Side Far Red", AutoBuilder.buildAuto("Auto4-P873Red"));
        // autoChooser.addOption("4 Piece Amp Side Far Red", AutoBuilder.buildAuto("Auto4-P146Red"));
